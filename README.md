# Commodore Component: Traefik Proxy

This is a [Commodore][commodore] Component for Traefik Proxy.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/traefik).
